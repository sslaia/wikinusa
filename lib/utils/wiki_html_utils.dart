...
class WikiHtmlUtils {
  ...
  static void fixUrls(dom.Element element, String langCode, String projectName) {
    ...
    element.querySelectorAll('img').forEach((img) {
      ...
      if (src != null) {
        if (src.startsWith('//')) {
          ...
          src = 'https://$langCode.$projectName.org$src';
        }
    ...
    element.querySelectorAll('a').forEach((a) {
      ...
      if (href != null && href.startsWith('/')) {
        a.attributes['href'] = 'https://$langCode.$projectName.org$href';
      }
    });
  }
}

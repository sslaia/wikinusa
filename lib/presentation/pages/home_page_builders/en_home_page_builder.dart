...
class EnglishHomePageBuilder implements HomePageBuilder {
      ...
      builder: (context, ref, child) {
        ...
        return rulesAsync.when(
          data: (rules) {
            ...
            String? headerBg;
            final featuredImageId = homePageSections['featuredImage'] ?? 'mp-tfp';
  ...
  String _getLabel(String key) {
    switch (key) {
      case 'featuredArticle': return 'From today\'s featured article';
      case 'featuredImage': return 'Today\'s featured picture';
      case 'doYouKnow': return 'Did you know...';
      case 'inTheNews': return 'In the news';

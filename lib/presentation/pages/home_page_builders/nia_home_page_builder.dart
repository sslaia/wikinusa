...
class NiasHomePageBuilder implements HomePageBuilder {
      ...
      builder: (context, ref, child) {
        ...
        return rulesAsync.when(
          data: (rules) {
            ...
            String? headerBg;
            final featuredImageId = homePageSections['featuredImage'] ?? homePageSections['featuredPhoto'];
            final featuredImageSection = sections.firstWhere((s) => s['id'] == featuredImageId, orElse: () => {});
  ...
  Map<String, dynamic>? _extractSection(dom.Document document, String id, String header, String langCode) {
    ...
    String finalBody = '';
    if (id == 'mp-featured-article' || id == 'mp-tfa') {
  ...
  String _getLabel(String key) {
    switch (key) {
      case 'featuredArticle': return 'Sura amilita';
      case 'featuredImage': return 'Gamara amilita';
      case 'featuredPhoto': return 'Gamara amilita';
      case 'doYouKnow': return "Hadia ö'ila";
      case 'onThisMonth': return 'Salua föna';
      case 'featuredWord': return 'Fehede amilita';
                ...
                for (var url in section['images'])
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        url.contains('/thumb/') ? WikiHtmlUtils.getHighResUrl(url) : url,
